var CACHE='rg-v6';
var ASSETS=['/','index.html','manifest.json','icon-192.png','icon-512.png','favicon.png','apple-touch-icon.png'];
...
if(e.request.url.indexOf('api.open-meteo.com')!==-1){e.respondWith(fetch(e.request).catch(function(){return new Response('{}',{status:503,headers:{'Content-Type':'application/json'}})}));return}
